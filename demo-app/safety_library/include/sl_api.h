 ...
 * @exitmode    SVC Mode
 *
 * @seealso     @ref SL_Init_StackPointers,  @ref SL_Init_VFPRegisters
 *
...
#elif defined(_TMS570LC43x_) || defined(_RM57Lx_)
 ...
 *
 * @param [in]	testType - Specifies the test type to execute.
 * @param [in] 	ramGroup - List of RAM Groups to be used for testing.
...
/**
 * @brief       This function generates an internal warm reset(nRST). This done by writing appropriate\n
 ...
 */
boolean SL_adcCalibration(sl_adcBASE_t *adc);
#endif
