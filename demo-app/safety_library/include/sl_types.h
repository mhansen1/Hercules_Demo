...
/** \typedef ESM_Application_Callback
  ...
  * \description The esm application call back happens only for the fault injections.There will be no callback in case of failures in the selftests.\n
  * The application should use the provided status function to get the status of the last selftest which was triggered.
  ...
  *
  ...
  |--------------------------|-----------------------------------------------------------------------------------------|
  | G2ERR_B1TCM_UNCORR       |     None                                                                                |
  |--------------------------|-----------------------------------------------------------------------------------------|
  | G2ERR_B0TCM_ADDPAR       |     None                                                                                |
  |--------------------------|-----------------------------------------------------------------------------------------|
  ...
  *
  */
  /*SAFETYMCUSW 298 S MR:- <APPROVED> "Reason -  ESM callback changes at runtime"*/
...
typedef enum _SL_SelfTest_Type {
    ...
    CCMR5F_CPUCOMP_SELF_TEST,                /**< CCMR4F Self-test (to be used
                                              with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_CPUCOMP_ERROR_FORCING_TEST,     /**< CCMR4F Error forcing test(to be
                                              used with API @ref
                                              SL_SelfTest_CCMR4F) */
    CCMR5F_CPUCOMP_ERROR_FORCING_TEST_FAULT_INJECT, /**< CCMR4F Error focing test, but
                                              does not clear the nERROR & ESM
                                              Interrupt (Callee function must
                                              clear these) (to be used with API
                                              @ref SL_SelfTest_CCMR4F)*/
    CCMR5F_CPUCOMP_SELF_TEST_ERROR_FORCING, /**< CCMR4F Self-test error forcing
                                              (to be used with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_VIMCOMP_SELF_TEST,               /**< CCMR4F Self-test (to be used
                                              with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_VIMCOMP_ERROR_FORCING_TEST,      /**< CCMR4F Error forcing test(to be
                                              used with API @ref
                                              SL_SelfTest_CCMR4F) */
    CCMR5F_VIMCOMP_ERROR_FORCING_TEST_FAULT_INJECT, /**< CCMR4F Error focing test, but
                                              does not clear the nERROR & ESM
                                              Interrupt (Callee function must
                                              clear these) (to be used with API
                                              @ref SL_SelfTest_CCMR4F)*/
    CCMR5F_VIMCOMP_SELF_TEST_ERROR_FORCING, /**< CCMR4F Self-test error forcing
                                              (to be used with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_PDCOMP_SELF_TEST,                /**< CCMR4F Self-test (to be used
                                              with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_PDCOMP_ERROR_FORCING_TEST,       /**< CCMR4F Error forcing test(to be
                                              used with API @ref
                                              SL_SelfTest_CCMR4F) */
    CCMR5F_PDCOMP_ERROR_FORCING_TEST_FAULT_INJECT, /**< CCMR4F Error focing test, but
                                              does not clear the nERROR & ESM
                                              Interrupt (Callee function must
                                              clear these) (to be used with API
                                              @ref SL_SelfTest_CCMR4F)*/
    CCMR5F_PDCOMP_SELF_TEST_ERROR_FORCING,  /**< CCMR4F Self-test error forcing
                                              (to be used with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_INMCOMP_SELF_TEST,               /**< CCMR4F Self-test (to be used
                                              with API @ref
                                              SL_SelfTest_CCMR4F)*/
    CCMR5F_INMCOMP_ERROR_FORCING_TEST,      /**< CCMR4F Error forcing test(to be
                                              used with API @ref
                                              SL_SelfTest_CCMR4F) */
    CCMR5F_INMCOMP_ERROR_FORCING_TEST_FAULT_INJECT, /**< CCMR4F Error focing test, but
                                              does not clear the nERROR & ESM
                                              Interrupt (Callee function must
                                              clear these) (to be used with API
                                              @ref SL_SelfTest_CCMR4F)*/
    CCMR5F_INMCOMP_SELF_TEST_ERROR_FORCING, /**< CCMR4F Self-test error forcing
                                              (to be used with API @ref
                                              SL_SelfTest_CCMR4F)*/
#if 0
    CCMR5F_CPU_DIAGNOSTIC,
    CCMR5F_VIM_DIAGNOSTIC,
    CCMR5F_CCIM_DIAGNOSTIC,
    CCMR5F_PDIM_DIAGNOSTIC,
#endif

    STC1_RUN,                               /**< CPU test using STC(to be used
                                              with API @ref SL_SelfTest_STC) */
    STC1_COMPARE_SELFCHECK,                 /**< STC self check diagnostic(to be
                                              used with API @ref
                                              SL_SelfTest_STC) */
    STC2_RUN,                               /**< */
    STC2_COMPARE_SELFCHECK,                 /**< */

    DMA_ECC_TEST_MODE_1BIT,
    DMA_ECC_TEST_MODE_2BIT,
    DMA_ECC_TEST_MODE_1BIT_FAULT_INJECT,
    DMA_ECC_TEST_MODE_2BIT_FAULT_INJECT,

    CAN_ECC_TEST_MODE_1BIT,
    CAN_ECC_TEST_MODE_2BIT,
    CAN_ECC_TEST_MODE_1BIT_FAULT_INJECT,
    CAN_ECC_TEST_MODE_2BIT_FAULT_INJECT,
    
    MIBSPI_ECC_TEST_MODE_1BIT,
    MIBSPI_ECC_TEST_MODE_2BIT,
    MIBSPI_ECC_TEST_MODE_1BIT_FAULT_INJECT,
    MIBSPI_ECC_TEST_MODE_2BIT_FAULT_INJECT
#endif
...
#define PBISTALGO_PMOS_OPEN_SLICE1_2PORT     (uint32)0x00004000u  /**<pmos open slice1 for 2port memories*/
#define PBISTALGO_PMOS_OPEN_SLICE2_2PORT     (uint32)0x00008000u  /**<pmos open slice2 for 2port memories*/
...
#define PBISTALGO_MARCH_DISTURB_INC_1PORT    (uint32)0x00000040u  /**<  */
#define PBISTALGO_MARCH_DISTURB_INC_2PORT    (uint32)0x00000080u  /**<  */
#define PBISTALGO_MARCH_DISTURB_DEC_1PORT    (uint32)0x00000100u  /**<  */
#define PBISTALGO_MARCH_DISTURB_DEC_2PORT    (uint32)0x00000200u  /**<  */
#define PBISTALGO_MARCH_DISTURB_INC_1PORT_1  (uint32)0x00000400u  /**<  */
#define PBISTALGO_MARCH_DISTURB_INC_2PORT_1  (uint32)0x00000800u  /**<  */
#define PBISTALGO_MARCH_DISTURB_DEC_1PORT_1  (uint32)0x00001000u  /**<  */
#define PBISTALGO_MARCH_DISTURB_DEC_2PORT_1  (uint32)0x00002000u  /**<  */
...
#define PBISTALGO_PMOS_OPEN_SLICE1_1PORT     (uint32)0x00400000u  /**<pmos open slice1 for 1port memories*/
#define PBISTALGO_PMOS_OPEN_SLICE1_2PORT     (uint32)0x00800000u  /**<pmos open slice1 for 2port memories*/
#define PBISTALGO_PMOS_OPEN_SLICE2_2PORT     (uint32)0x01000000u  /**<pmos open slice2 for 2port memories*/
#endif
/**@}*/
