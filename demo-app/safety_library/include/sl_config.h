 ...
 */
/**@{*/
#define STACK_SIZE_MODE_SVC 1u   /**< Stack size for SVC mode */
#define STACK_SIZE_MODE_FIQ 1u   /**< Stack size for FIQ mode */
#define STACK_SIZE_MODE_IRQ 1u   /**< Stack size for IRQ mode */
#define STACK_SIZE_MODE_ABT 1u   /**< Stack size for ABT mode */
#define STACK_SIZE_MODE_UND 1u   /**< Stack size for UND mode */
#define STACK_SIZE_MODE_SYS 1u   /**< Stack size for SYS mode */
/**@}*/
...
#define FUNCTION_ENTRY_CONDITION_CHECK_ENABLED 	1u /**< When defined enables the entry codition check at function entry */
...
#endif
#if defined(FUNCTION_PARAM_CHECK_ENABLED) || defined(FUNCTION_ENTRY_CONDITION_CHECK_ENABLED)
