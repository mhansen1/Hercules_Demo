...
#define PMM_PRCKEYREG_MKEY_LOCKSTEP_MODE			(uint32)0x00000000u
#define PMM_PRCKEYREG_MKEY_SELF_TEST_MODE           (uint32)0x00000006u
#define PMM_PRCKEYREG_MKEY_ERROR_FORCING_MODE       (uint32)0x00000009u
#define PMM_PRCKEYREG_MKEY_ST_ERROR_FORCING_MODE    (uint32)0x0000000Fu
