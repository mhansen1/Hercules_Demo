...
#define F021F_FDIAGCTRL_DIAGMODE_DATA_CORR  (uint32)0x00000001U
#define F021F_FDIAGCTRL_DIAGMODE_SYN_RPT    (uint32)0x00000002U
...
#define F021F_FDIAGCTRL_DIAGMODE_ADDR_TAG   (uint32)0x00000005U
#define F021F_FDIAGCTRL_DIAGMODE_P_BUF_PAR  (uint32)0x00000006U
#define F021F_FDIAGCTRL_DIAGMODE_TEST_MODE  (uint32)0x00000007U
